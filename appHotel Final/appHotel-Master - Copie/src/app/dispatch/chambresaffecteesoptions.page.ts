...
@Component({
  selector: 'app-chambres-affectees-options',
  templateUrl: './chambresaffecteesoptions.page.html',
  styleUrls: ['./chambresaffecteesoptions.page.scss'],
})

export class ChambresAffecteesOptionsPage implements OnInit {
  chambre: ChambresAffectees;
  data: any;
  ...
  constructor(
    ...
    private modalCtrl: ModalController) {
      console.log("la chambre en question "+this.chambre);
  }
